...
# computing (f(R0,K1) XOR L0)
    ...
    def plaintext_conversion(self,plaintext):
        ...
        print ("the plain characters are: ", characters)
        return characters
...
# Stream of data to be decrypted
    ...
    for i in range(0, len(blocks)):
        ...
        print("'Decryption of block ",i+1," at the end of 2 round of encryption given by RiLi: '", Decrypted_Block, '\n\n\n')
        plaintext+=Decrypted_Block
    print('Plaintext in bits: ', plaintext, '\n')
